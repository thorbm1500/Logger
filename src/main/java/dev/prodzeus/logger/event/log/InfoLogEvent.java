...
public class InfoLogEvent extends GenericLogEvent {
    ...
    public InfoLogEvent(@NotNull final Logger logger, @NotNull final Marker marker, @NotNull final String log, @NotNull final Collection<Object> args) {
    ...
    public InfoLogEvent(@NotNull final Logger logger, @NotNull final Marker marker, @NotNull final String log, @NotNull final Object... args) {
    ...
    public InfoLogEvent(@NotNull final Logger logger, @NotNull final Marker marker, @NotNull final String log, @NotNull final Object arg) {
    ...
    public InfoLogEvent(@NotNull final Logger logger, @NotNull final Marker marker, @NotNull final String log) {
